...
<div id="page-wrapper">
    <div class="row">
        <div class="col-12 col-md-12 col-lg-12">
            <a  style="float: right;" href="{{URL::to('admin/announcement/create')}}" class="btn btn-primary pull-right"> Add Announcement</a>
        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('announcement.destroy',$row->id) }}"  method="POST"> 
                                                 <a class="btn btn-primary" href="{{ route('announcement.edit',$row->id) }}">Edit</a>
                                                    @csrf
                                                    @method('DELETE')
