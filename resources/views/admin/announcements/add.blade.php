...
<div class="row">
    <div class="col-12 col-md-12 col-lg-12">
            ...
            <div class="card-body"> 
                ...
                @endif
                <form  action="{{URL::to('admin/announcement/')}}" name="form1" id="form1" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                    @csrf
                    ...
                    <div class="panel-body">
                        ...
                        <div id="txtDoc" style="display: none;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        <textarea name="description" onkeypress="return onlyAlphabets(event,this);"  id="editor" class="form-control" rows="3" aria-hidden="true"><?php echo old('description'); ?></textarea>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-xm-12">
                                <div class="pull-right">
                                    ...
                                    <a href="{{URL::to('admin/announcement/')}}" class="btn btn-primary" >back</a>
                                </div>
                            </div>
                        </div>
                    </div>
