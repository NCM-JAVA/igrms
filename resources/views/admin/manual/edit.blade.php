...
<div class="row">
    <div class="col-12 col-md-12 col-lg-12">
            ...
            <div class="card-body"> 
                ...
                <form  action="{{ route('manual.update' , $data->id) }}" name="form1" id="form1" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                    @csrf
                    @method('PUT')
                          ...
                          <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <a  class="w-50" target="_blank" href="{{ URL::asset('public/upload/admin/cmsfiles/manuals/')}}/{{$data->txtuplode}}" > View PDF</a>
