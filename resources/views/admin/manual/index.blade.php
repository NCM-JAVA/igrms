...
@section('content')
@section('title', 'Manage Manual')
<div class="card">
    <div class="card-body"> 
<div id="page-wrapper">
    <div class="row">
        <div class="col-12 col-md-12 col-lg-12">
            <a  style="float: right;" href="{{URL::to('admin/manual/create')}}" class="btn btn-primary pull-right"> Add Manual</a>
        </div>
						         ...
						         <?php
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('manual.destroy',$row->id) }}"  method="POST"> 
                                                 <a class="btn btn-primary" href="{{ route('manual.edit',$row->id) }}">Edit</a>
                                                    @csrf
                                                    @method('DELETE')
