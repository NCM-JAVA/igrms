@extends('layouts.master'); @section('content') @section('title', 'Exhibition')
<div class="card">
    <div class="card-body">
        <div id="page-wrapper">
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                    <a style="float: right;" href="{{URL::to('admin/exhibition/create')}}" class="btn btn-primary pull-right"> Add Exhibition</a>
                </div>
            </div>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('exhibition.destroy',$row->id) }}"  method="POST"> 
                                                    <a class="btn btn-primary" href="{{ route('exhibition.edit',$row->id) }}">Edit</a>
                                                    @csrf
                                                    @method('DELETE')
