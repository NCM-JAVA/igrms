...
@section('content')
@section('title', 'Edit Sanghralaya Details')
...
<div class="row">
    <div class="col-12 col-md-12 col-lg-12">
            ...
            <div class="card-body"> 
                ...
                @endif
                <form  action="{{ route('sanghralaya.update' , $data->id) }}" name="form1" id="form1" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                @csrf
                    @method('PUT')
					...
					<div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    <textarea name="description" id="editor" class="input_class form-control  @error('description') is-invalid @enderror">{{ !empty($data->description)?$data->description:old('description')}}</textarea>
                        ...
                        <div class="row" id="txtPDF" >
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                ...
                                <img style="margin-bottom: 5%;" class="w-50 img-responsive" alt="image" id="logoimg" src="{{ URL::asset('public/upload/admin/cmsfiles/sanghralaya/thumbnail/')}}/{{$data->txtuplode}}" class="rounded-circle mr-1" />
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-xm-12">
                                <div class="pull-right">
                                    ...
                                    <a href="{{URL::to('admin/sanghralaya/')}}" class="btn btn-primary" >back</a>
                                </div>
                            </div>
                        </div>
                    </div>
