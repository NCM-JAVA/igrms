@extends('layouts.master'); @section('content') @section('title', 'Exhibition Category Details')
<div class="card">
    <div class="card-body">
        <div id="page-wrapper">
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                    <a style="float: right;" href="{{URL::to('admin/exhibition-category/create')}}" class="btn btn-primary pull-right"> Add Exhibition Category</a>
                </div>
            </div>
                ...
                <form action="#" class="search_inbox" name="form1" id="form1" method="post" accept-charset="utf-8">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-2">
                           <input onchange="search(this);" class="form-control" type="text" name="category" value="{{Session::get('category')??''}}">
                        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('exhibition-category.destroy',$row->id) }}"  method="POST"> 
                                                    <a class="btn btn-primary" href="{{ route('exhibition-category.edit',$row->id) }}">Edit</a>
                                                    @csrf
                                                    @method('DELETE')
