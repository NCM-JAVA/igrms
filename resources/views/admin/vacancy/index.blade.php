...
<div id="page-wrapper">
    <div class="row">
        <div class="col-12 col-md-12 col-lg-12">
            <a  style="float: right;" href="{{URL::to('admin/vacancy/create')}}" class="btn btn-primary pull-right"> Add Vacancy</a>
        </div>
						         ...
						         <?php
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('vacancy.destroy',$row->id) }}"  method="POST"> 
                                                 <a class="btn btn-primary" href="{{ route('vacancy.edit',$row->id) }}">Edit</a>
                                                    @csrf
                                                    @method('DELETE')
