                        ...
                        <div class="row useful-links d-flex">
                            <div class="col-12 col-md-3">
                                ...
                                @foreach($firstHalf as $mod)
                                    ...
                                    <?php $i++ ; ?>
                                @endforeach 
                                {{-- Manually added link in same format --}}
        ...
        <script src= "{{ URL::asset('/public/assets/js/js/jquery.min.js')}}"></script>
        <script src= "{{ URL::asset('/public/assets/js/js/main.js')}}"></script>
        <script src= "{{ URL::asset('/public/assets/js/js/bootstrap.bundle.min.js')}}"></script>
        <script src= "{{ URL::asset('/public/assets/js/js/jquery-3.3.1.slim.min.js')}}" integrity="sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo" crossorigin="anonymous"></script>
<script src= "{{ URL::asset('/public/assets/js/js/popper.min.js')}}" integrity="sha384-wHAiFfRlMFy6i5SRaxvfOCifBUQy1xHdJ/yoi7FRNXMRBu5WHdZYu1hA6ZOblgut" crossorigin="anonymous"></script>
<!-- <script>
