    ...
    <div class="row inner_page">
      ...
      <div class="col-lg-9">
        <div class="content-div px-3">
                            ...
                            <tr>
                                ...
                                <td> 
                                    @if(!empty($row->txtuplode))
                                        <a target="_blank" class="btn btn-sm btn-primary" href="{{ URL::asset('public/upload/admin/cmsfiles/circulars/')}}/{{$row->txtuplode}}" title="{{$row->txtuplode}}" > Download
            ...
            {!! $announcement->withQueryString()->links('pagination::bootstrap-5') !!} @php $pageurl = substr(clean_single_input(request()->segment(2)),0,4); @endphp
