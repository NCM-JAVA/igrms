...
class AnnouncementController extends Controller
{
    ...
    public function index()
    {
        ...
        $list = Circular::where('circularstype', '3')->paginate(10);
        return view('admin/announcements/index',compact(['list','langid','title']));
    }
    ...
    public function create()
    {
       ...
       return view('admin/announcements/add',compact(['title']));
    }
       ...
       if ($validator->fails()) {
        return  back()->withErrors($validator)->withInput();
           ...
           if($lastInsertID > 0){
            ...
            'page_title'        	=> 'Announcement Model',
            'approve_status'        => clean_single_input($request->txtstatus),
            'usertype'          	=> 'Admin'
        );
                           
               audit_trail($audit_data);
               return redirect('admin/announcement')->with('success','Announcement has successfully added');
           }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin/announcements/edit',compact(['title','data']));
    }
       ...
       if ($validator->fails()) {
           ...
           if($create > 0){
            $audit_data = array('user_login_id'     =>  $user_login_id,
               ...
               audit_trail($audit_data);
               return redirect('admin/announcement')->with('success','Announcement has successfully Updated');
           }
